...
Login Salesforce And Navigate To Analytics
    ...
    ClickText    *Account Name    timeout=15
    Sleep    2s
    ClickText    New Account    anchor=Recent Accounts
    UseModal    On
    TypeText    Phone    8444444444
    TypeText    *Account Name    RODRIGORECIO5    anchor=Opportunity Name
    TypeText    Fax    123
    TypeText    Website    racewear.com.mx
    TypeText    Description    blkabla
    TypeText    Billing Street    mi casa
    TypeText    Billing City    saltillo
